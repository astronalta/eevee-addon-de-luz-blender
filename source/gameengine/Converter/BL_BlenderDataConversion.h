...
class RAS_GameObject* BL_ConvertRasGameObj(struct Mesh* mesh, struct Object* lightobj, class KX_Scene* scene, class RAS_Rasterizer *rasty,
		class KX_BlenderSceneConverter& converter, bool libloading);
